...
import SlideItem11 from "../assets/sliderItems/BestDeal10.jpg";
import SlideItem10 from "../assets/sliderItems/BestDeal2.jpg";
import SlideItem9 from "../assets/sliderItems/BestDeal3.jpg";
import SlideItem14 from "../assets/sliderItems/BestDeal4.jpg";
import SlideItem12 from "../assets/sliderItems/BestDeal8.jpg";
import SlideItem13 from "../assets/sliderItems/BestDeal9.jpg";
...
import Dispose from "../assets/sliderItems/item6.jpg";
      ...
      <div className="h-[320px] w-full overflow-hidden sm:rounded-2xl bg-[url('./assets/rocks/rocks.jpg')]">
        <div className="flex flex-row h-full overflow-auto bg-cover bg-gradient-to-r from-transparent via-slideGradient via-50% sm:via-30% to-slideGradient">
          <div className="flex flex-col translate-x-3 sm:-translate-x-3 sm:flex-row items-center justify-center w-1/3 sm:w-60 lg:w-80 h-full mr-20 ">
            <img
              src={Dispose}
              className="sm:translate-x-8 w-full sm:w-[270px]"
              alt=""
            />
